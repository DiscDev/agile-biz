...
// Configuration paths
const CONFIG_FILE = '.claude/agents/logs/logging-config.json';
const LOG_FILE = '.claude/agents/logs/agents.json';
const ERROR_LOG_FILE = '.claude/agents/logs/error.log';
